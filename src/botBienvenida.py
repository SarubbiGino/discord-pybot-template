...
def main():
    ...
    def create_config_archive():
        template = {
        'prefix': '', 
        'token': "MTA3MzAzMjk0MTQ1MTYxNjMzOA.GRdvCn.3Tall0YVLVLjGxLnTLJAEfoVO3kV9Ac-eWlvEA", 
        }
    ...
    async def on_member_join(member):
        ...
        # Damos la bienvenida
        await welcome_channel.send(f'Bienvenido al servidor, escribiendo "comandos" (PODRAS VER LAS PALABRAS CLAVES PARA INTERACTUAR CONMIGO) {str(member.mention)}. Revisa tus mensajes privados para aceptar las reglas del servidor y poder acceder a los demás canales.')
